from PySide6.QtWidgets import QMainWindow, QMessageBox, QToolBar, QPushButton, QLabel, QColorDialog, QMenuBar, QSlider, QFileDialog
from PySide6.QtGui import QPixmap, QKeySequence, QColor, QPolygonF
...
class MyWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        edit_menu.addAction("Leeren (Ctrl+X)", self.paint_area.clear_canvas).setShortcut(
        ...
        #Add buttons for new operations
    ...
    def on_deform_clicked(self):
        self.paint_area.apply_subdivision_deformation(iterations=3)
    ...
    def set_tool(self, tool_name):
        ...
        if self.paint_area.current_tool == tool_name:   #wanted to add code to reset to pen, hope it works
        ...
        for btn in [self.rect_tool, self.circle_tool, self.star_tool]:
            btn.setStyleSheet("") #resets the buttons i think?
